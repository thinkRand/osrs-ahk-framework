...
*/
/*
Tooltip, % "esta Lleno = " interfaceEnPrueba.estaLleno() 
sleep 2000
...
loop, % interfaceEnPrueba.celda.length()
{
	...
	if (interfaceEnPrueba.celdaEstaVacia(interfaceEnPrueba.celda[A_index]) = 1)
	{
		Tooltip, % "Celda " A_index " esta vacia" 
		sleep 2000
	
	}
	else
	{
		Tooltip, % "Celda " A_index " esta LLena " 
		sleep 2000
	}
